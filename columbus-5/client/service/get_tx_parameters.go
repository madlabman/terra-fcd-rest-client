...
// WithDefaults hydrates default values in the get tx params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTxParams) WithDefaults() *GetTxParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get tx params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTxParams) SetDefaults() {
...
// WithHash adds the hash to the get tx params
func (o *GetTxParams) WithHash(hash string) *GetTxParams {
	o.SetHash(hash)
	return o
}

// SetHash adds the hash to the get tx params
func (o *GetTxParams) SetHash(hash string) {
	o.Hash = hash
}
