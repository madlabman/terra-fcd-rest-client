...
// WithDefaults hydrates default values in the get syncing params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSyncingParams) WithDefaults() *GetSyncingParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get syncing params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSyncingParams) SetDefaults() {
