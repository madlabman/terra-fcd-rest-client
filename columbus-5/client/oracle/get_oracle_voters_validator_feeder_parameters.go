...
/* GetOracleVotersValidatorFeederParams contains all the parameters to send to the API endpoint
   for the get oracle voters validator feeder operation.
...
// WithDefaults hydrates default values in the get oracle voters validator feeder params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOracleVotersValidatorFeederParams) WithDefaults() *GetOracleVotersValidatorFeederParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get oracle voters validator feeder params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOracleVotersValidatorFeederParams) SetDefaults() {
