...
/* GetOracleDenomsDenomExchangeRateOK describes a response with status code 200, with default header values.
...
/* GetOracleDenomsDenomExchangeRateBadRequest describes a response with status code 400, with default header values.
...
/* GetOracleDenomsDenomExchangeRateInternalServerError describes a response with status code 500, with default header values.
