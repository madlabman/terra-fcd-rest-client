...
/* GetDistributionValidatorsValidatorAddrParams contains all the parameters to send to the API endpoint
   for the get distribution validators validator addr operation.
...
// WithDefaults hydrates default values in the get distribution validators validator addr params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDistributionValidatorsValidatorAddrParams) WithDefaults() *GetDistributionValidatorsValidatorAddrParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get distribution validators validator addr params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDistributionValidatorsValidatorAddrParams) SetDefaults() {
