...
/* GetSlashingSigningInfosOK describes a response with status code 200, with default header values.

OK
*/
type GetSlashingSigningInfosOK struct {
	Payload []*GetSlashingSigningInfosOKBodyItems0
}
...
func (o *GetSlashingSigningInfosOK) GetPayload() []*GetSlashingSigningInfosOKBodyItems0 {
	return o.Payload
}
...
/* GetSlashingSigningInfosBadRequest describes a response with status code 400, with default header values.
...
/* GetSlashingSigningInfosInternalServerError describes a response with status code 500, with default header values.
...
/*GetSlashingSigningInfosOKBodyItems0 get slashing signing infos o k body items0
swagger:model GetSlashingSigningInfosOKBodyItems0
*/
type GetSlashingSigningInfosOKBodyItems0 struct {
...
// Validate validates this get slashing signing infos o k body items0
func (o *GetSlashingSigningInfosOKBodyItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get slashing signing infos o k body items0 based on context it is used
func (o *GetSlashingSigningInfosOKBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetSlashingSigningInfosOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetSlashingSigningInfosOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetSlashingSigningInfosOKBodyItems0
