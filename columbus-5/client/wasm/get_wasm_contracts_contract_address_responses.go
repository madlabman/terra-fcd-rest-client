...
/* GetWasmContractsContractAddressOK describes a response with status code 200, with default header values.
...
// ContextValidate validates this get wasm contracts contract address o k body based on context it is used
func (o *GetWasmContractsContractAddressOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
