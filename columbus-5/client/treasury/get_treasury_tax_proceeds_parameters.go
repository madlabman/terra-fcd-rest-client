...
/* GetTreasuryTaxProceedsParams contains all the parameters to send to the API endpoint
   for the get treasury tax proceeds operation.
...
// WithDefaults hydrates default values in the get treasury tax proceeds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTreasuryTaxProceedsParams) WithDefaults() *GetTreasuryTaxProceedsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get treasury tax proceeds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTreasuryTaxProceedsParams) SetDefaults() {
