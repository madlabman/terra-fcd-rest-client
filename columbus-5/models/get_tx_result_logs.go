...
type GetTxResultLogs struct {
	...
	// events
	// Required: true
	Events []*GetTxResultLogsEvents `json:"events"`

	// log
	// Required: true
	Log *GetTxResultLogsLog `json:"log"`
...
// Validate validates this get tx result logs
func (m *GetTxResultLogs) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTxResultLogs) validateEvents(formats strfmt.Registry) error {
...
func (m *GetTxResultLogs) validateLog(formats strfmt.Registry) error {
...
func (m *GetTxResultLogs) validateMsgIndex(formats strfmt.Registry) error {
...
func (m *GetTxResultLogs) validateSuccess(formats strfmt.Registry) error {
...
func (m *GetTxResultLogs) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTxResultLogs) UnmarshalBinary(b []byte) error {
	var res GetTxResultLogs
