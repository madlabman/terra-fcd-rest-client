...
func (m *Accounts) validateAccount(formats strfmt.Registry) error {
...
func (m *Accounts) validateAmount(formats strfmt.Registry) error {
...
func (m *Accounts) validatePercentage(formats strfmt.Registry) error {
...
// ContextValidate validates this accounts based on context it is used
