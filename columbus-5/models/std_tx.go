...
// ContextValidate validate this std tx based on the context it is used
func (m *StdTx) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StdTx) contextValidateFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StdTx) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
type StdTxFee struct {
	...
	// amount
	Amount []*StdTxFeeAmountItems0 `json:"amount"`
...
// ContextValidate validate this std tx fee based on the context it is used
func (m *StdTxFee) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StdTxFee) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
// StdTxFeeAmountItems0 std tx fee amount items0
//
// swagger:model StdTxFeeAmountItems0
type StdTxFeeAmountItems0 struct {
...
// Validate validates this std tx fee amount items0
func (m *StdTxFeeAmountItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this std tx fee amount items0 based on context it is used
func (m *StdTxFeeAmountItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StdTxFeeAmountItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *StdTxFeeAmountItems0) UnmarshalBinary(b []byte) error {
	var res StdTxFeeAmountItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
	...
	if m.PubKey != nil {
		if err := m.PubKey.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("signature" + "." + "pub_key")
			}
			return err
		}
	}
...
// ContextValidate validate this std tx signature based on the context it is used
func (m *StdTxSignature) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StdTxSignature) contextValidatePubKey(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validates this std tx signature pub key based on context it is used
func (m *StdTxSignaturePubKey) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
