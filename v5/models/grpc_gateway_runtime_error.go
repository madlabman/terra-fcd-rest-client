...
type GrpcGatewayRuntimeError struct {
	...
	// details
	Details []*GrpcGatewayRuntimeErrorDetailsItems0 `json:"details"`
...
// GrpcGatewayRuntimeErrorDetailsItems0 `Any` contains an arbitrary serialized protocol buffer message along with a
...
//     }
//
// swagger:model GrpcGatewayRuntimeErrorDetailsItems0
type GrpcGatewayRuntimeErrorDetailsItems0 struct {
...
// Validate validates this grpc gateway runtime error details items0
func (m *GrpcGatewayRuntimeErrorDetailsItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this grpc gateway runtime error details items0 based on context it is used
func (m *GrpcGatewayRuntimeErrorDetailsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GrpcGatewayRuntimeErrorDetailsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *GrpcGatewayRuntimeErrorDetailsItems0) UnmarshalBinary(b []byte) error {
	var res GrpcGatewayRuntimeErrorDetailsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
