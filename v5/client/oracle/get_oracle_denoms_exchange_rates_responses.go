...
/* GetOracleDenomsExchangeRatesOK describes a response with status code 200, with default header values.

OK
*/
type GetOracleDenomsExchangeRatesOK struct {
	Payload []*GetOracleDenomsExchangeRatesOKBodyItems0
}
...
func (o *GetOracleDenomsExchangeRatesOK) GetPayload() []*GetOracleDenomsExchangeRatesOKBodyItems0 {
	return o.Payload
}
...
/* GetOracleDenomsExchangeRatesBadRequest describes a response with status code 400, with default header values.
...
/* GetOracleDenomsExchangeRatesInternalServerError describes a response with status code 500, with default header values.
...
/*GetOracleDenomsExchangeRatesOKBodyItems0 get oracle denoms exchange rates o k body items0
swagger:model GetOracleDenomsExchangeRatesOKBodyItems0
*/
type GetOracleDenomsExchangeRatesOKBodyItems0 struct {
...
// Validate validates this get oracle denoms exchange rates o k body items0
func (o *GetOracleDenomsExchangeRatesOKBodyItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get oracle denoms exchange rates o k body items0 based on context it is used
func (o *GetOracleDenomsExchangeRatesOKBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetOracleDenomsExchangeRatesOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetOracleDenomsExchangeRatesOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetOracleDenomsExchangeRatesOKBodyItems0
