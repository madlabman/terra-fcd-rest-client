...
/* GetLatestValidatorSetParams contains all the parameters to send to the API endpoint
   for the get latest validator set operation.
...
// WithDefaults hydrates default values in the get latest validator set params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLatestValidatorSetParams) WithDefaults() *GetLatestValidatorSetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get latest validator set params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLatestValidatorSetParams) SetDefaults() {
...
// WithPaginationCountTotal adds the paginationCountTotal to the get latest validator set params
func (o *GetLatestValidatorSetParams) WithPaginationCountTotal(paginationCountTotal *bool) *GetLatestValidatorSetParams {
	o.SetPaginationCountTotal(paginationCountTotal)
	return o
}

// SetPaginationCountTotal adds the paginationCountTotal to the get latest validator set params
func (o *GetLatestValidatorSetParams) SetPaginationCountTotal(paginationCountTotal *bool) {
	o.PaginationCountTotal = paginationCountTotal
}

// WithPaginationKey adds the paginationKey to the get latest validator set params
func (o *GetLatestValidatorSetParams) WithPaginationKey(paginationKey *strfmt.Base64) *GetLatestValidatorSetParams {
	o.SetPaginationKey(paginationKey)
	return o
}

// SetPaginationKey adds the paginationKey to the get latest validator set params
func (o *GetLatestValidatorSetParams) SetPaginationKey(paginationKey *strfmt.Base64) {
	o.PaginationKey = paginationKey
}

// WithPaginationLimit adds the paginationLimit to the get latest validator set params
func (o *GetLatestValidatorSetParams) WithPaginationLimit(paginationLimit *string) *GetLatestValidatorSetParams {
	o.SetPaginationLimit(paginationLimit)
	return o
}

// SetPaginationLimit adds the paginationLimit to the get latest validator set params
func (o *GetLatestValidatorSetParams) SetPaginationLimit(paginationLimit *string) {
	o.PaginationLimit = paginationLimit
}

// WithPaginationOffset adds the paginationOffset to the get latest validator set params
func (o *GetLatestValidatorSetParams) WithPaginationOffset(paginationOffset *string) *GetLatestValidatorSetParams {
	o.SetPaginationOffset(paginationOffset)
	return o
}

// SetPaginationOffset adds the paginationOffset to the get latest validator set params
func (o *GetLatestValidatorSetParams) SetPaginationOffset(paginationOffset *string) {
	o.PaginationOffset = paginationOffset
}

// WithPaginationReverse adds the paginationReverse to the get latest validator set params
func (o *GetLatestValidatorSetParams) WithPaginationReverse(paginationReverse *bool) *GetLatestValidatorSetParams {
	o.SetPaginationReverse(paginationReverse)
	return o
}

// SetPaginationReverse adds the paginationReverse to the get latest validator set params
func (o *GetLatestValidatorSetParams) SetPaginationReverse(paginationReverse *bool) {
