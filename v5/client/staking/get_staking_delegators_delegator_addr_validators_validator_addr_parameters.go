...
/* GetStakingDelegatorsDelegatorAddrValidatorsValidatorAddrParams contains all the parameters to send to the API endpoint
   for the get staking delegators delegator addr validators validator addr operation.
...
// WithDefaults hydrates default values in the get staking delegators delegator addr validators validator addr params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStakingDelegatorsDelegatorAddrValidatorsValidatorAddrParams) WithDefaults() *GetStakingDelegatorsDelegatorAddrValidatorsValidatorAddrParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get staking delegators delegator addr validators validator addr params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStakingDelegatorsDelegatorAddrValidatorsValidatorAddrParams) SetDefaults() {
