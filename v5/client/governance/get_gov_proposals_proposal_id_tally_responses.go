...
/* GetGovProposalsProposalIDTallyOK describes a response with status code 200, with default header values.
...
/* GetGovProposalsProposalIDTallyBadRequest describes a response with status code 400, with default header values.
...
/* GetGovProposalsProposalIDTallyInternalServerError describes a response with status code 500, with default header values.
...
// ContextValidate validates this get gov proposals proposal ID tally o k body based on context it is used
func (o *GetGovProposalsProposalIDTallyOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
