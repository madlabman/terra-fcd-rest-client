...
/* GetGovProposalsProposalIDDepositsParams contains all the parameters to send to the API endpoint
   for the get gov proposals proposal ID deposits operation.
...
// WithDefaults hydrates default values in the get gov proposals proposal ID deposits params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetGovProposalsProposalIDDepositsParams) WithDefaults() *GetGovProposalsProposalIDDepositsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get gov proposals proposal ID deposits params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetGovProposalsProposalIDDepositsParams) SetDefaults() {
