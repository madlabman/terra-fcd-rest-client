...
/* GetDistributionCommunityPoolParams contains all the parameters to send to the API endpoint
   for the get distribution community pool operation.
...
// WithDefaults hydrates default values in the get distribution community pool params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDistributionCommunityPoolParams) WithDefaults() *GetDistributionCommunityPoolParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get distribution community pool params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDistributionCommunityPoolParams) SetDefaults() {
