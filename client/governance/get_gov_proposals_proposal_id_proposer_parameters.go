...
/* GetGovProposalsProposalIDProposerParams contains all the parameters to send to the API endpoint
   for the get gov proposals proposal ID proposer operation.
...
// WithDefaults hydrates default values in the get gov proposals proposal ID proposer params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetGovProposalsProposalIDProposerParams) WithDefaults() *GetGovProposalsProposalIDProposerParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get gov proposals proposal ID proposer params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetGovProposalsProposalIDProposerParams) SetDefaults() {
