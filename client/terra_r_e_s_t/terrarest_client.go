...
// New creates a new terra r e s t API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for terra r e s t API
*/
type Client struct {
...
type ClientService interface {
	GetNodeInfo(params *GetNodeInfoParams, opts ...ClientOption) (*GetNodeInfoOK, error)
...
*/
func (a *Client) GetNodeInfo(params *GetNodeInfoParams, opts ...ClientOption) (*GetNodeInfoOK, error) {
