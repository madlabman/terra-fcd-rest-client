...
/* GetOracleVotersValidatorFeederOK describes a response with status code 200, with default header values.
...
func (o *GetOracleVotersValidatorFeederOK) GetPayload() string {
	return o.Payload
}
...
/* GetOracleVotersValidatorFeederBadRequest describes a response with status code 400, with default header values.
...
/* GetOracleVotersValidatorFeederInternalServerError describes a response with status code 500, with default header values.
