...
// CosmosTxV1beta1TxBody body is the processable content of the transaction
//
// TxBody is the body of a transaction that all signers sign over.
//
// swagger:model CosmosTxV1beta1TxBody
	...
	for i := 0; i < len(m.ExtensionOptions); i++ {
		...
		if m.ExtensionOptions[i] != nil {
			if err := m.ExtensionOptions[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("body" + "." + "extension_options" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("body" + "." + "extension_options" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	for i := 0; i < len(m.Messages); i++ {
		...
		if m.Messages[i] != nil {
			if err := m.Messages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("body" + "." + "messages" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("body" + "." + "messages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	for i := 0; i < len(m.NonCriticalExtensionOptions); i++ {
		...
		if m.NonCriticalExtensionOptions[i] != nil {
			if err := m.NonCriticalExtensionOptions[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("body" + "." + "non_critical_extension_options" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("body" + "." + "non_critical_extension_options" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
